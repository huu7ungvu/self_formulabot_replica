          ...
          <div className="flex flex"> 
            <div className="mr-4">
              ...
              <input
                ...
                disabled={loading}
                className="mt-2 bg-blueGray-700 text-white font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none ease-linear transition-all duration-150"
              />
            </div>
